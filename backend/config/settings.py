"""
Django settings for student services website project.
"""
...
# Add Render domain if not in production ALLOWED_HOSTS
if not DEBUG:
    ...
    if DATABASE_URL:
        ...
        DATABASES = {
            'default': {
                ...
                'NAME': config('POSTGRES_DB', default='student_services'),
...
# Use dummy backend that doesn't send emails
EMAIL_BACKEND = config('EMAIL_BACKEND', default='django.core.mail.backends.dummy.DummyEmailBackend')
EMAIL_HOST = config('EMAIL_HOST', default='localhost')
EMAIL_PORT = config('EMAIL_PORT', default=587, cast=int)
EMAIL_USE_TLS = config('EMAIL_USE_TLS', default=True, cast=bool)
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='')
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='noreply@studentservices.com')

# Frontend URL for email links
FRONTEND_URL = config('FRONTEND_URL', default='http://localhost:3000')

# Cache Configuration
# Use simple cache for development, Redis for production
if DEBUG:
    CACHES = {
        'default': {
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'PaperPath API',
    'DESCRIPTION': 'API for PaperPath website',
    'VERSION': '1.0.0',
